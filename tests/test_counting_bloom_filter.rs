...
fn test_get_hash_count() {
    let bf: bloom::CountingBloomFilter = bloom::CountingBloomFilter::new(10000, 0.01);
...
fn test_false_positive_rate() {
    let mut bf: bloom::CountingBloomFilter = bloom::CountingBloomFilter::new(10000, 0.01);
    for i in 0..10000 {
